                                    ...
                                    <form className="form form-vertical" onSubmit={handleSubmit}>
                                        <div className="form-body">
                                            <div className="row">
                                                ...
                                                <div className="col-12">
                                                    <div className="form-group">
                                                    <label for="email-id-vertical">Order notes</label>
                                                    <input type="text" id="email-id-vertical" className="form-control" defaultValue={inputs.ordernotes} name="ordernotes" onChange={handleChange} placeholder="ordernotes"/>
                                                    </div>
                                                </div>
                                                <div className="col-12">
                                                    <div className="form-group">
                                                    <label for="email-id-vertical">Order date</label>
                                                    <input type="text" id="email-id-vertical" className="form-control" defaultValue={inputs.orderdate} name="orderdate" onChange={handleChange} placeholder="orderdate"/>
                                                    </div>
                                                </div>
