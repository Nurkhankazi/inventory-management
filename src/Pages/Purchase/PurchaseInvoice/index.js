...
function Invoice() {
    ...
    useEffect(() => {
        async function fetchPurchase() {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/purchase/${purchaseId}`);
                      ...
                      <g id="Icon" transform="translate(27.000000, 15.000000)">
                        ...
                        <g
                          ...
                          <use fillOpacity="0.2" fill="#FFFFFF" xlinkHref="#path-5"></use>
                                ...
                                <h1>Purchase Invoice</h1><br/>
                            </div>
                        </header>

                        {/* Purchase and Suppliers Details */}
                            ...
                            <table className="details-table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{purchase.supplier?.contactperson}</td>
                                    </tr>
                                    <tr>
                                        <th>Mobile No:</th>
                                        <td>{purchase.supplier?.phonenumber}</td>
                                    </tr>
                                    <tr>
                                        <th>Email:</th>
                        ...
                        <section className="purchase-summary">
                            ...
                            <table className="summary-table">
                                ...
                                <tbody>
                                    {purchase.details && purchase.details.map((item, key) => (
                                        <tr key={item.id}>
                                    ...
                                    <tr>
                                        <td colSpan="3" className="subtotal-label">Discount</td>
                                        <td>{purchase.discountamt}</td>
                                    </tr>
                                    <tr>
                                        <td colSpan="3" className="subtotal-label">Tax</td>
                                        <td>{purchase.taxamt}</td>
                                    </tr>
                                    <tr>
                                        <td colSpan="3" className="grandtotal-label"><strong>Grand Total</strong></td>
                                        <td><strong>{purchase.gtotal}</strong></td>
                                    </tr>
                                    <tr>
                                        <td colSpan="2" className="grandtotal-label"><strong>Payment:</strong></td>
                                        <td><strong>{purchase?.payment_sum_amount}</strong></td>
                                    </tr>
                                    <tr>
                                        <td colSpan="2" className="grandtotal-label"><strong>Due Amount:</strong></td>
                                        <td><strong>{purchase?.gtotal && purchase?.payment_sum_amount?
                                        (purchase.gtotal - purchase.payment_sum_amount).toFixed(2): 'N/A'}
                                        </strong></td>
                                    </tr>
                                </tbody>
                            </table>
