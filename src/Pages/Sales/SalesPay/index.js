...
function SalesPay() {
    ...
    const [salesData, setSalesData] = useState({check_date:'',bank_name:'',check_number:''});
    ...
    const handleSubmit = async(e) => {
        ...
        try{
            let apiurl=`/sales/payment/${id}`;//api from laravel
            ...
            <div className="page-title">
                <div className="row">
                    <div className="col-12 col-md-12 order-md-1 order-last">
                        <br/><h1 style={{textAlign: 'center'}}>Sales Payment</h1>
                    </div>
                </div>
            </div>
                                        ...
                                        <div className="form-body">
                                            <div className='row'> 
                                                <div className="col-6 offset-6 d-flex justify-content-end">
                                                    {salesData.gtotal > 0 &&
                                                        <h3>Due Amount: {salesData.gtotal - salesData.payment_sum_amount}</h3>
                                                    }
                                                </div>
                                            </div>
                                            {/* Payment type */}
