...
function Invoice() {
    ...
    useEffect(() => {
        async function fetchSales() {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/sales/${salesId}`);
                console.log(response.data.data);  // ডেটা চেক করুন
                      ...
                      <g id="Icon" transform="translate(27.000000, 15.000000)">
                        ...
                        <section className="sales-summary">
                            ...
                            <table className="summary-table">
                                ...
                                <tbody>
                                    {sales.details && sales.details.map((item, key) => (
                                        <tr key={item.id}>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>{sales.gtotal}</strong></td>
                                    </tr>
                                    <tr>
                                        <td colSpan="2" className="grandtotal-label"><strong>Payment:</strong></td>
                                        <td><strong>{sales?.payment_sum_amount}</strong></td>
                                    </tr>
                                    <tr>
                                        <td colSpan="2" className="grandtotal-label"><strong>Due Amount:</strong></td>
                                        <td><strong>{sales?.gtotal && sales?.payment_sum_amount?
                                        (sales.gtotal - sales.payment_sum_amount).toFixed(2): 'N/A'}
                                        </strong></td>
                                    </tr>
                                </tbody>
                            </table>
